...
def add_special_character(name):
    """
    Adds a random special character in the middle of a name.
    ...
    return name[:middle_index] + special_character + name[middle_index:]
...
for index, row in ofac_list_sampled.iterrows():
    ...
    if number_of_words_first_middle != 1:
        ...
        modified_name = add_special_character(separated_words[1])
