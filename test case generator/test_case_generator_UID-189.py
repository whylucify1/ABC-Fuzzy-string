...
import pandas as pd
from test_case_generator_functions import separate_words_in_name
...
for index, row in ofac_list_sampled.iterrows():
    last_name, first_name_middle_names_parts, middle_names = separate_words_in_name(row['name']) # add this line to call separate_words_in_name
    full_name = first_name_middle_names_parts + ' ' + middle_names + ' ' + last_name
    final_test_name = first_name_middle_names_parts + rand_letter() + ' ' + middle_names + ' ' + last_name
