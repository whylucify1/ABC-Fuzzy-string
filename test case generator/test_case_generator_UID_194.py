...
uid = 'UID-194' 
theme = 'Names where name parts are modifed'
category = 'Character removal from the middle of the name part'
sub_category = '2 characters removal'
entity_type = 'Entity'
...
for index, row in ofac_list_sampled.iterrows():
    ...
    final_name = name[:middle_index-1] + name[middle_index+1:]
