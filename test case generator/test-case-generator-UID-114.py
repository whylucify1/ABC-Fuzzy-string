...
def replace_designator(full_name, matching_word):
    ...
    if matching_word_count == 3:
        ...
        new_word_3 = random.choice(matching_word)
        while new_word_2 == new_word_1 or new_word_3 == new_word_1 or new_word_3 == new_word_2:
            new_word_2 = random.choice(matching_word)
            new_word_3 = random.choice(matching_word)
        name_parts[matching_indices[0]] = new_word_1
        name_parts[matching_indices[1]] = new_word_2
        name_parts[matching_indices[2]] = new_word_3
