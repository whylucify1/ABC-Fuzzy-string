...
for index, row in ofac_list_sampled.iterrows():
    ...
    matching_words3 = random.choice(cp_last_name_list)
    words.insert(0, str(matching_words1).upper())
    words.insert(1, str(matching_words2).upper())
    words.insert(2, str(matching_words3).upper())
