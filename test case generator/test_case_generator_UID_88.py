...
for index, row in ofac_list_sampled.iterrows():
    name = row['name']
    qualifiers = ["Jr", "Sr", "i", "ii", "iii", "iv", "v", "vi", "vii", "viii", "ix", "x", "Prof"]
    # Create a regular expression to match the qualifiers
    qualifier_pattern = r"\b(" + "|".join(qualifiers) + r")\b"

    # Use the regular expression to remove the qualifiers from the name
    clean_name = re.sub(qualifier_pattern, "", name, flags=re.IGNORECASE)
