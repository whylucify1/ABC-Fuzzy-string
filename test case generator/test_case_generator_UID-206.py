...
for index, row in ofac_list_sampled.iterrows():
    ...
    if number_of_words_first_middle != 1:
        ...
        name1 = separated_words[1] 
        index1 = random.randint(0, len(name1)-1)

        modified_name1 = name1[:index1] + str(random.randint(0,9)) + name1[index1+1:]

         
        
        name0 = separated_words[0] 
        index2 = random.randint(0, len(name0)-1)

        modified_name0 = name0[:index2] + str(random.randint(0,9)) + name0[index2+1:]
