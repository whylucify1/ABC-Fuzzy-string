...
import pandas as pd
from test_case_generator_functions import remove_first_name
...
for index, row in ofac_list_sampled.iterrows():
    ...
    final_test_name = cut_last_two_words(busdes_names)
...
#%%
final_test_cases.to_csv('74.csv', index=False)   