...
category = 'initials'
sub_category = 'All given name initials (First & Middle)'
...
for index, row in ofac_list_sampled.iterrows():
    ...
    if number_of_words_first_middle != 1:
        ...
        abbreviated_middle_name = separated_words[1][0]
        final_test_name = abbreviated_first_name + '.' + ' ' +  abbreviated_middle_name + '.' + ' ' + separated_words[2]  #create the test case        
