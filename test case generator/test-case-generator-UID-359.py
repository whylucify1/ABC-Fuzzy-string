...
def compress_non_common_name_parts(name):
    common_parts = ['COMPANY', 'LTD', 'LLC', 'C.V.', 'S.A.', 'C.A.', 'INC', 'LDA', 'LTDA',
                    'LTD.','S.A.S.','CO','CO.','LIMITED','PTE.','L.T.D.','SAL']
...
final_test_cases.to_csv('final_test_cases_359.csv', index=False, columns=['UID', 'Theme', 'Category', 'Sub-category', 'Entity-Type', 'Original Name', 'Test Case Name'])
