...
def repeat_random_letters(name):
    ...
    while len(indices) < 3:
        ...
        if letter in repeated_letters or letter not in string.ascii_letters:
            continue
...
final_test_cases[['Sub-category', 'Original Name', 'Test Case Name']].to_csv('test_cases_227.csv', index=False, header=['Test Type', 'Original Name', 'Altered Name'])
