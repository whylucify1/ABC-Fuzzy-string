...
import pandas as pd
from test_case_generator_functions import remove_two_names
...
for index, row in ofac_list_sampled.iterrows():
    ...
    final_test_name = remove_two_names(busdes_names)
...
#%%
final_test_cases.to_csv('65.csv', index=False)  