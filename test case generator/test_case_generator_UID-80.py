...
final_test_cases[['UID','Theme','Category',	'Sub-category',	'Entity-Type',	'Original Name',	'Test Case Name']].to_csv('test_cases_80.csv', index=False, header=['UID','Theme','Category',	'Sub-category',	'Entity-Type',	'Original Name','Test Case Name'])
