...
category = 'initials'
sub_category = 'Last Name Initial'
...
for index, row in ofac_list_sampled.iterrows():
    ...
    if number_of_words_first_middle != 1:
        ...
        abbreviated_last_name = separated_words[2][0]
        final_test_name = separated_words[0] + ' ' + separated_words[1] + ' ' + abbreviated_last_name + '.'  #create the test case        
        ...
        abbreviated_last_name = separated_words[1][0]
        final_test_name = separated_words[0] + ' ' + abbreviated_last_name + '.'  #create the test case        
        final_test_cases.loc[len(final_test_cases)] = [uid, theme, category, sub_category, entity_type, uid + ' - ' + str(index), row['uid'], row['name'], final_test_name.upper()] # append to the dataframe
        print(final_test_cases)