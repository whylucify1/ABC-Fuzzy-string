...
sub_category = '>2 Middle Names added'
...
def add_random_middle_name(name, middle_name_list):
        ...
        middle_name3 = random.choice(middle_name_list)
        full_name_parts = [first_name] + [middle_name1] + [middle_name2] + [middle_name3]+ first_name_middle_names_parts[1:]
