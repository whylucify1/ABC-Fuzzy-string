...
for index, row in ofac_list_sampled.iterrows():
    ...
    if number_of_words_first_middle >=4 : 
        separated_words = separate_words_in_name_5(row['name'])
        final_test_name = separated_words[0] + " " + separated_words[3] +" " + separated_words[1] + " " + separated_words[2]+ " " + separated_words[4]+ " " + separated_words[5]
